      ...
      <div className="mx-auto flex h-16 max-w-7xl items-center gap-3 px-4 sm:px-6">
              ...
              <SheetTitle asChild>
                ...
                >
                  <img
                    src={logo}
                    alt="Kala Flavours"
                    className="size-11 shrink-0 rounded-full border border-primary-foreground/30 object-cover"
                  />
        ...
        <nav className="ml-4 hidden items-center gap-1 lg:flex">
          ...
          >
            ...
            {megaOpen && (
              <div className="absolute left-1/2 top-full w-[640px] max-w-[92vw] -translate-x-1/2 pt-2">
        ...
        <Button
          variant="ghost"
          size="sm"
          className="relative ml-auto gap-1.5 px-2 sm:ml-0 sm:px-3 md:ml-2"
        ...
        >
          ...
          {count > 0 && (
            <span className="absolute -right-0.5 -top-0.5 grid min-w-5 place-items-center rounded-full bg-gold-gradient px-1 text-[11px] font-bold text-gold-foreground sm:hidden">
              {count}
            </span>
          )}
        </Button>
