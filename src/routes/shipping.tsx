...
export const Route = createFileRoute("/shipping")({
  head: () => ({
    meta: [
      { title: "Shipping Information — Kala Flavours" },
      {
        name: "description",
        content:
          "Delivery timelines, packaging and shipping charges for Kala Flavours orders across India.",
      },
    ],
  }),
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6">
      ...
      <div className="prose mt-6 max-w-none space-y-4 text-sm text-muted-foreground">
        <p>
          Every Kala Flavours order is packed to order in leak-proof jars and pouches, then shipped
