...
export const Route = createFileRoute("/terms")({
  head: () => ({
    meta: [
      { title: "Terms & Conditions — PickleMart" },
      { name: "description", content: "Terms and conditions for shopping with PickleMart." },
    ],
  }),
  component: TermsPage,
});
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6">
      ...
      <div className="prose mt-6 max-w-none space-y-4 text-sm text-muted-foreground">
        <p>
          By ordering from PickleMart, you agree to the following terms. We may update this page
          from time to time.
        </p>
        <p>
