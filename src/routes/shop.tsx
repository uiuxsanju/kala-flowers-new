...
export const Route = createFileRoute("/shop")({
  head: () => ({
    meta: [
      { title: "Shop All Products — Kala Flavours" },
      {
        name: "description",
        content:
          "Browse the full Kala Flavours range — pickles, masalas, spice powders, vadiyalu, snacks and sweets. Filter by category, veg/non-veg, price and weight.",
      },
    ],
  }),
  component: ShopPage,
